...
frase1 = 'Persiga um ideal, não o dinheiro. O dinheiro vai acabar indo atrás de você'
frase2 =  'Você não precisa de uma equipe de 100 pessoas para desenvolver uma ideia'


blob = TextBlob(frase2,  classifier=cl)
#
print('Esta frase e de carater: {}'.format(blob.classify()))
print('Precisao de previsao: {}'.format(accuracy))
